...
library(tidyverse)
anime <- read_csv(
  here::here("original_data/anime.csv"),
  col_types = cols(
...
write.csv(anime, here::here("data/anime_tidy.csv"))
```
...
anime_list <- read.csv(here::here("original_data/animelist.csv"))
```
...
write.csv(anime_with_ratings, here::here("data/anime_with_ratings.csv"))
