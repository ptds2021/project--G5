...
anime_with_ratings <-
  tibble::tibble(ProjectG5::anime_with_ratings)

Gender_list <-
  base::unique(base::as.vector(stringr::str_split(
...
header <-
  shinydashboard::dashboardHeader(title = "Anime Recommendation")
...
body <- shinydashboard::dashboardBody(
  shinydashboard::tabItems(
    ...
    shinydashboard::tabItem(
      ...
      shiny::tags$h3(
        "This application was done for a project at HEC
                             Lausanne for a master class named
                             'Programming tools'."
      ),
      shiny::tags$h3(
        "Its main aim is to make the user of our
      ...
      shiny::tags$h3(
        "Are you a great expert or are you a novice with
                             no knowledge about anime?"
      ),
      shiny::tags$h3(
        "For the newbies: go to the first tab to have
                             recommendation according to your age, time that you
                             have before you and type that you like."
      ),
      shiny::tags$h3(
        "For experts: go to the next two tabs. The first
    ...
    shinydashboard::tabItem(
      ...
      shiny::tags$h3(
        "In this tab, simply enter your age, your type of
    ...
    shinydashboard::tabItem(
      ...
      shiny::tags$h3(
        "In this tab, you will need to start by selecting
