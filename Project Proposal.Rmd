...
We will all work on the project but some tasks will be more specific to certain people: 

- Meri will take care of cleaning the data well, keeping only the necessary and making it "usable" for our work.

- Massimo and Xavier will take care of the parts of the code that need the most attention.

- Vania will take care of visualizing what we want to put on our application.

- Marie will take care of the design of the site, so that it will be nice and easy to read/use.
